...
test('homepage declares the PNG favicon and the local server serves it', async (t) => {
  ...
  assert.equal(png.readUInt32BE(16), 512, 'favicon canvas must use the standard 512px height');
  assert.equal(png.readUInt32BE(20), 512, 'favicon canvas must use the standard 512px width');
